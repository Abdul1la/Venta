...
import { LayoutDashboard, Store, Package, CreditCard, LogOut, Menu, X, Settings, Sun, Moon } from 'lucide-react';
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div className="mobile-only" style={{
        padding: '16px', background: 'var(--color-bg-card)', borderBottom: '1px solid var(--color-border)',
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        <aside
          ...
          style={{
            ...
            height: '100%',
            zIndex: 50,
            transform: (window.innerWidth <= 768 && !mobileMenuOpen) ? `translateX(${i18n.dir() === 'rtl' ? '100%' : '-100%'})` : 'translateX(0)',
        ...
        >
          <div style={{ marginBottom: '40px', paddingLeft: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <span style={{ fontSize: '12px', color: '#999', fontWeight: 500 }}>{t('common.adminRole')}</span>
            </div>
          ...
          <nav style={{ flex: 1 }}>
            <SidebarItem to="/warehouse" icon={LayoutDashboard} label={t('common.dashboard')} />
            <SidebarItem to="/warehouse/branches" icon={Store} label={t('common.branches')} />
            <SidebarItem to="/warehouse/settings" icon={Settings} label={t('common.settings')} />
          </nav>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <header style={{
            height: '64px', background: 'var(--color-bg-card)', borderBottom: '1px solid var(--color-border)',
